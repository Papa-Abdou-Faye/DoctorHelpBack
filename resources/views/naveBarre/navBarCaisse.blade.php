    ...
    <nav class="sidebar fermer">
        <header>
            <div class="image-text">
                <span class="image">
                    <img src="{{ asset('image/med.png') }}" style="height: 140px">
                </span>
                <div class="text header-text">
                    <a href="{{ route('acc.med') }}" style="text-decoration: none; color: white"><span class="name">DOCTOR's help</span></a>
                </div>
            </div>
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="{{ route('consultation.med')  }}">
                            <i class='bx bxs-donate-heart icons'></i>
                            <span class="text nav-text">Depenses</span>
                        </a>
                    </li>
                    <li class="nav-link">
                        <a href="{{ route('register.med')  }}">
                            <i class='bx bxs-book icons'></i>
                            <span class="text nav-text">Reliquat</span>
                        </a>
                    </li>
                    <li class="nav-link">
                        <a href="{{ route('ins.med') }}">
                            <i class='bx bx-user-plus icons'></i>
                            {{-- <i class='bx bx-user-plus icons'></i>   --}}
                            <span class="text nav-text">Rapport</span>
                        </a>
                    </li>
                    <li class="nav-link">
                        <a href="{{ route('doc') }}">
