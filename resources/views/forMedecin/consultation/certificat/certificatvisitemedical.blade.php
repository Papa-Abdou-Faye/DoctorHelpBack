...
<div class="popupConsult" id="popupConsult" >
    <form action="{{ route('enrcvmedical') }}" method="POST" class="formIns med">
    ...
    <div class="lien" style="background: rgb(240, 240, 240); left: 25px; height: 70%; width: 30%; position: relative; float: left;overflow: scroll;" >
            ...
            <table style="" class="table table-hover" >
                <div class="bk" style=" width: 100%;height: 40px; color: white; text-align: center; padding-top: 8px; font-weight: 600; font-size: 900;">
                    Certificat de visite Medicale par Date
                </div>
                @if(session('cvmdcal_first') == true)
                  @foreach ($cmedicales as $cm)
                    <tr style=" width: 100%;height: 40px;  font-weight: 600; font-size: 900">
                        <td><a href="{{ url('voircvmedical/'.$cm->id) }}" class="cl">certificat du  {{ $cm->created_at }}</a></td>
                    </tr>
                  @endforeach
                @endif
            </table>
            ...
            <table class=" table-hover" style="width: 100%"><?php $aujourdhui = date("d-m-Y"); ?>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <span style="font-family: Impact; font-style: italic"> {{$cmdcal->lieu_nai}} </span> et atteste Mr/ Mme <span style="font-family: Impact; font-style: italic">{{$patient->nom}} </span> ne présente aucune maladie contagieuse grave qui
                                        pourrait porter atteinte à la santé publique conformément aux dispositions du reglement de santé internationale de 2005<br>
                                        En conclusion, Mr/ Mme ::::::::::::::: pour constitution de son dossier administrattif
                            ...
                            <tr>
                                <td>
                                    ...
                                    <span style="font-family: Impact; font-style: italic">::::::::::::::::::: </span> et atteste Mr/ Mme <span style="font-family: Impact; font-style: italic">::::::::::::::::::::: </span> ne présente aucune maladie contagieuse grave qui
                                    pourrait porter atteinte à la santé publique conformément aux dispositions du reglement de santé internationale de 2005<br>
                                    En conclusion, Mr/ Mme ::::::::::::::: pour constitution de son dossier administrattif.
                                    <div style="font-family: 'Times New Roman'; text-align: center"> Fait à Touba le {{ $aujourdhui  }}</div><br>
                                    <div style="font-family: 'Times New Roman'; text-decoration: underline; text-align: right"> Le Medecin</div>
