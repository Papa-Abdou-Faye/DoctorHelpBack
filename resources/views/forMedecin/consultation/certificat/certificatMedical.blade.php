...
<div class="popupConsult" id="popupConsult" >
    <form action="{{ route('enrcM') }}" method="POST" class="formIns med">
    <select class="textinsMed solide" name="consultation_id">
        ...
        @csrf
            ...
            <input type="textarea" name="pathologie" style="width: 600px; height: 100px;margin-top: 20px; border: none" placeholder="                                                                    Pathologie ">
        <div style="width: 100%">
...
<div class="pageMedConDossier" style="background: none">
    <div class="lien" style="background: rgb(240, 240, 240); left: 25px; height: 70%; width: 30%; position: relative; float: left;overflow: scroll;" >
            ...
            <table style="" class="table table-hover" >
                ...
                @if(session('cmdcal_first') == true)
                  @foreach ($cmedicales as $cm)
                    <tr style=" width: 100%;height: 40px;  font-weight: 600; font-size: 900">
                        <td><a href="{{ url('voircM/'.$cm->id) }}" class="cl">Certificat du  {{ $cm->created_at }}</a></td>
                    </tr>
                  @endforeach
                @endif
            </table>
            ...
            <table class=" table-hover" style="width: 100%"><?php $aujourdhui = date("d-m-Y"); ?>
                            ...
                            <tr>
                                <td>
                                    ...
                                    Je soussigné, Dr <span style="font-family: Impact; font-style: italic">{{Auth::user()->prenom}} {{Auth::user()->nom}} </span> certifie avoir recu en   consultation
                                    Mr/Mme <br> <span style="font-family: Impact; font-style: italic"> {{$patient->prenom}} {{$patient->nom}} </span> né (e) le  <span style="font-family: Impact; font-style: italic">{{Auth::user()->date_nai}} </span>à
                                    ...
                                    A l'issu de son examen Mr/Mme <span style="font-family: Impact; font-style: italic"> {{$patient->nom}}</span> est atteint(e)
                                    <span style="font-family: Impact; font-style: italic">{{$cmdcal->pathologie}}</span> et suivi(e) dans notre Service.<br>
                                    <span style="font-family: 'Times New Roman'">Ce présent certificat est établi pour servir et valoir ce que de droit.</span><br>
                        ...
                        <tr>
                            <td>
                                ...
                                A l'issu de son examen Mr/Mme <span style="font-family: Impact; font-style: italic"> ::::::::::::::::::::::::::</span> est atteint(e)
                                <span style="font-family: Impact; font-style: italic">:::::::::::::::::::::::::</span> et suivi(e) dans notre Service.<br>
                                <span style="font-family: 'Times New Roman'">Ce présent certificat est établi pour servir et valoir ce que de droit.</span><br>
                                <div style="font-family: 'Times New Roman'; text-align: center"> Fait à Touba le {{ $aujourdhui  }}</div><br>
                                <div style="font-family: 'Times New Roman'; text-decoration: underline; text-align: right"> Le Medecin</div>
                                </div>
