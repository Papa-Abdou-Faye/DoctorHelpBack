...
<div class="popupConsult" id="popupConsult" >
    <form action="{{ route('enrcMplus') }}" method="POST" class="formIns med">
    ...
    @csrf  <div>
                    <input type="text" name="lieu_nai" style="width: 250px; height: 50px;margin-top: 20px; border: none; float: left;" placeholder="Lieu de naissance">
                    <span style="float: left;">Date consultation</span>
                    <input type="date" name="dateaccident" style="width: 150px; height: 50px;margin-top: 20px; border: none; float: left; margin-left: 10px" >
            </div>
            <textarea name="diagnostic" style="width: 600px; height: 100px;margin-top: 20px; border: none" placeholder="                                                               Pathologie "></textarea>
            <input type="text" name="incapacite" style="width: 600px; height: 50px;margin-top: 20px; border: none" placeholder="                                                                    Incapacité de  ">
        <div style="width: 100%">
    ...
    <div class="lien" style="background: rgb(240, 240, 240); left: 25px; height: 70%; width: 30%; position: relative; float: left;overflow: scroll;" >
            ...
            <table style="" class="table table-hover" >
                <div class="bk" style=" width: 100%;height: 40px; color: white; text-align: center; padding-top: 8px; font-weight: 600; font-size: 900;">
                    Certificats Medicaux par Date
                </div>
                @if(session('cmdcalplus_first') == true)
                  @foreach ($cmedicales as $cm)
                    <tr style=" width: 100%;height: 40px;  font-weight: 600; font-size: 900">
                        <td><a href="{{ url('voircMplus/'.$cm->id) }}" class="cl">Certificat du  {{ $cm->created_at }}</a></td>
                    </tr>
                  @endforeach
                @endif
            </table>
            ...
            <table class=" table-hover" style="width: 100%"><?php $aujourdhui = date("d-m-Y"); ?>
                            ...
                            <tr>
                                <td>
                                    <div style="position: absolute; font-size: 23px; text-align: justify">
                                        Je soussigné, Dr <span style="font-family: Impact; font-style: italic">{{Auth::user()->prenom}} {{Auth::user()->nom}} </span> certifie avoir examné ce jour du <span style="font-family: 'Times New Roman'; text-align: center"> {{ $aujourdhui  }}</span>
                                        Mr/Mme/Mlle <span style="font-family: Impact; font-style: italic"> {{$patient->prenom}} {{$patient->nom}} </span> né (e) le  <span style="font-family: Impact; font-style: italic">{{$patient->date_nai}}</span> à
                                        <span style="font-family: Impact; font-style: italic">{{$cmdcal->lieu_nai}}</span> demeurant à <span style="font-family: Impact; font-style: italic">{{$patient->adresse}}</span>: <br>
                                        Disant etre victime de coup et blessures le <span style="font-family: Impact; font-style: italic">{{$cmdcal->dateaccident}} </span>.<br>
                                        L'examen clinique révéle <br><span style="font-family: Impact; font-style: italic">{{$cmdcal->dignostic}} </span><br>
                                        Son état de santé  nécessite une incapacité totale temporaire de <span style="font-family: Impact; font-style: italic">{{$cmdcal->incapacite}} </span> sauf complications ultérieures.<br>
                                        <span style="font-family: 'Times New Roman'">En foi de quoi ce présent certificat est délivré  pour servir et valoir ce que de droit.</span><br>
                                        <div style="font-family: 'Times New Roman'; text-align: center"> Fait à Touba le {{ $aujourdhui  }}</div><br>
                        ...
                        <tr>
                            <td>
                                <div style="position: absolute; font-size: 23px; text-align: justify">
                                Je soussigné, Dr <span style="font-family: Impact; font-style: italic">{{Auth::user()->prenom}} {{Auth::user()->nom}} </span> certifie avoir examné ce jour du <span style="font-family: 'Times New Roman'; text-align: center"> {{ $aujourdhui  }}</span>
                                Mr/Mme/Mlle <span style="font-family: Impact; font-style: italic"> ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::</span> né (e) le  <span style="font-family: Impact; font-style: italic">:::::::::::::::::::::::::::::::::::::::</span> à
                                <span style="font-family: Impact; font-style: italic">:::::::::: </span> demeurant à <span style="font-family: Impact; font-style: italic">::::::::::::::::::::::::::::</span>: <br>
                                Disant etre victime de coup et blessures le <span style="font-family: Impact; font-style: italic">:::::::::::::::::::::::::: </span>.<br>
                                L'examen clinique révéle <br><span style="font-family: Impact; font-style: italic">::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: </span><br>
                                Son état de santé  nécessite une incapacité totale temporaire de <span style="font-family: Impact; font-style: italic">:::::::::::::::::::::: </span> sauf complications ultérieures.<br>
                                <span style="font-family: 'Times New Roman'">En foi de quoi ce présent certificat est délivré  pour servir et valoir ce que de droit.</span><br>
                                <div style="font-family: 'Times New Roman'; text-align: center"> Fait à Touba le {{ $aujourdhui  }}</div><br>
                                <div style="font-family: 'Times New Roman'; text-decoration: underline; text-align: right"> Le Medecin</div>
                                </div>
